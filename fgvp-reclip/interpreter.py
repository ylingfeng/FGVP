...
class Environment:
    ...
    def filter(self,
        ...
        result_partial, boxes = self.executor(caption, self.image, boxes, image_name=self.image_name, caption_bank=caption_bank)
        for i in candidate_indices:
            self.returned_boxes[i] = boxes[i]
